...
class SelectBoxSugar extends React.Component {
    state = {
            ...
            <form className='select-box-box' action='/createCoffee' method='POST' >
                <div className='select-box-container'>
                    <div className='select-box-selected-item'> {this.state.selectedItem.value}
                        <input name='sugar' value={this.state.selectedItem.value} />
                </div>
                ...
                <input className='confirm' type='submit'></input>  
            </form>   
        )
    }
}

export default SelectBoxSugar;